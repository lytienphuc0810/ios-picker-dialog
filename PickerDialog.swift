...
class PickerDialog: UIView, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.cancelButton.addTarget(self, action: #selector(self.buttonTapped(_:)), for: .touchUpInside)
        ...
        self.doneButton.addTarget(self, action: #selector(self.buttonTapped(_:)), for: .touchUpInside)
